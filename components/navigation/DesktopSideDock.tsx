...
interface DesktopSideDockProps {
  activeModule: Module;
...
const dockItems: { id: Module; label: string; index: string }[] = [
  { id: 'standby', label: 'SYS', index: '01' },
  { id: 'quick', label: 'QUICK', index: '02' },
  { id: 'simulator', label: 'PRACTICE', index: '03' },
  { id: 'history', label: 'HISTORY', index: '04' },
  { id: 'therapist', label: 'THERAPY', index: '05' },
  { id: 'profile', label: 'PROFILE', index: '06' },
];

export const DesktopSideDock: React.FC<DesktopSideDockProps> = ({
  activeModule,
  setModule,
  authUser,
  onSignOut,
  ...
  return (
    <div className={`hidden md:flex w-20 border-r border-zinc-800 bg-matte-base flex-col items-center py-6 z-50 h-full relative ${className}`}>
      <div className="mb-10">
...
export default DesktopSideDock;
