            ...
            <div className="w-full max-w-md flex flex-col gap-12">
              <div className="space-y-8">
                {screenshots.map((src, index) => (
                  ...
                  >
                    <img src={src} alt="Message Screenshot" className="w-full h-auto object-contain" />
                    <button
                ...
                {showHint && (
                  <div className="absolute -top-16 left-0 w-full animate-bounce z-10">
                    <div className="bg-amber-400 text-black text-[10px] font-bold px-4 py-2 rounded-full flex items-center gap-3 shadow-2xl mx-auto w-fit">
                      <Info size={14} />
                      <span className="uppercase tracking-widest">Add context for better results</span>
                ...
                {showAdvanced && (
                  <div className="space-y-8 animate-slide-up bg-white/5 p-8 rounded-3xl border border-white/5">
                    <div className="space-y-3">
                      <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Background Info</label>
                      <textarea
                        value={context}
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest px-1">Your Draft</label>
                      <textarea
                        value={yourDraft}
            ...
            <div className="flex-1 flex items-center justify-center w-full min-h-[50vh]">
              ...
              >
                ...
                <div className="text-center px-8">
                  <p className="text-white font-bold text-2xl mb-2">Upload Conversation</p>
                  <p className="text-zinc-500 text-xs font-medium leading-relaxed">Select screenshots of your messages for analysis</p>
                </div>
              </button>
            </div>
          )}
          ...
          <div className="max-w-md mx-auto">
            {screenshots.length > 0 && (
              <button
                ...
                disabled={isLoading}
                className={`w-full py-5 rounded-2xl font-black text-xl uppercase tracking-tight shadow-2xl active:scale-[0.98] transition-all flex items-center justify-center gap-4 disabled:opacity-70 ${
                  isLoading 
